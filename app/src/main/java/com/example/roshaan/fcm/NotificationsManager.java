package com.example.roshaan.fcm;
...
import com.example.roshaan.fcm.ui.SingleDeviceFCM;
...
public class NotificationsManager {
    ...
    public void displayNotification(String title, String body) {
        ...
        *  Right now we are using the SingleDeviceFCM as this is the only activity we have in our application
        *  But for your project you can customize it as you want
        * */

        Intent resultIntent = new Intent(mCtx, SingleDeviceFCM.class);
